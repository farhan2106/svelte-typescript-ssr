...
const vComplex = new Validator(signInSchema);
...
$: {
  errorsInput.usernameOrEmail = getError(errors, 'usernameOrEmail') || ''
  errorsInput.password = getError(errors, 'password') || ''
}

// html functions
function signInHandler (this: HTMLFormElement, e: KeyboardEvent) {
